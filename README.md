...
### Particularities
Due to the particularities of the Swiss Games Garden data, having a canton entry only for Appenzell, instead of the two official cantons Appenzell Innerrhoden and Appenzell Ausserrhoden, I had to merge the two cantons into one on the map.
